/* Demonstrates passing a pointer to a multidimensional array to a function. */
...
int main()
{
    ...
    /* ptr is a pointer to an aray of 4 ints. */

    int (*ptr)[4], count;

    /* Set ptr to point to the first element multi. */
...
void printarray_1(int (*ptr)[4])
{
    ...
    /* to make p equal to the address in ptr. 0*/
