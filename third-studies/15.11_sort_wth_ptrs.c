...
/* Function for storing keyboard input. */
int get_lines(char *lines[])
{
    int n = 0;
...
/* Function that manages what type of sort will be executed. */
void sort(char *p[], int n, int sort_type)
{
    int a, b;
    char *x;
...
/* Function that sorts in alphabetical order. */
int alpha(char *p1, char *p2)
{
    return(strcmp(p2, p1));
}
...
/* Function that sorts in reverse-alphabetical order. */
int reverse(char *p1, char *p2)
{
    return(strcmp(p1, p2));
}
