...
{
    char name[20];
    struct data *next;  /* Pointer to data called next. */
};
...
int main()
{
    /* Head, new, and current elment pointers. */
    LINK head = NULL;
    LINK new = NULL;
    LINK current = NULL;

    /* Add the first listelement. We do not assume the list is empty, */
    /* although in this demo program it always will be. */
